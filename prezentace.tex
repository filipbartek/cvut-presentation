...
\newcommand\Department{\gls{cyber}}
\newcommand\Faculty{\acrlong{fel}}
\newcommand\University{\acrlong{ctu}}
\newcommand\FacultyAndUniversityAbbr{\acrshort{fel} \acrshort{ctu}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subtitle{BBB}
\subject{SUBJECT}
...
%\institute[\FacultyAndUniversityAbbr]{\acrlong{ciirc}\\ \University}
\date{\today}
%
\begin{document}
\begin{frame}
